...
|  **Alchemie LV 1**  | | |  **0**  |
| Kräuterkunde LV 1 | Grundwissen über Kräuter und Pflanzen, deren Wirkung und Verwendbarkeit: Gewährt +1 bei der Verwendung und Identifikation von Kräutern. |
| „Brauen&quot; (T) (M) | Tätigkeit: Der Charakter stellt ein alchemisches Erzeugnis (wie einen Trank) her. (Siehe Tätigkeiten) |
|  **+ Alchemie LV 2**  | | |  **3**  |
| + Kräuterkunde LV 2 | Erweitertes Grundwissen über Kräuter und Pflanzen: Gewährt nochmalig +1 (insg. +2) bei der Verwendung und Identifikation von Kräutern. |
| „Alchemischeskonzentrieren&quot; (T) | Tätigkeit: Der Charakter konzentriert zwei Einheiten zu einer. (Siehe Tätigkeiten) |
|  **+ Alchemie LV 3**  | | |  **6**  |
| + Kräuterkunde LV 3 | Erweitertes Wissen über Kräuter und Pflanzen: Gewährt nochmalig +1 (insg. +3) bei der Verwendung und Identifikation von Kräutern. |
| Zugang: Essenzherstellung | Ermöglicht es, konzentrierte Essenzen und herzustellen. (Muss nicht aufgeschrieben werden) |
|  **+ Alchemie LV 4**  || |  **9**  |
| Zugang: Bombenherstellung | Ermöglicht es, Bomben herzustellen. (Muss nicht aufgeschrieben werden) |
| + Kräuterkunde LV 4 | Fundiertes Wissen über Kräuter und Pflanzen: Gewährt nochmalig +1 (insg. +4) bei der Verwendung und Identifikation von Kräutern. |
| „Korrekte Applikation&quot; | Mithilfe korrekter Dosierung kann der Charakter den Effekt von Tränken, Elixiere, Essenzen usw. um 50% steigern. |
|  **+ Alchemie LV 5**  |||  **12**  |
| + Kräuterkunde (vollständig) | Tiefgehendes Wissen über Kräuter und Pflanzen: Gewährt nochmalig +1 (insg. +5) bei der Verwendung und Identifikation von Kräutern. |
| Giftimmunität | Routine und hohe Kenntnis gewähren dem Charakter hohe Immunität gegen Gifte (WD +30). |
|  **Erweiterung: Chemie**  |  **Benötigt Alchemie LV 2**  | | **3** |
| Mengeneffizienz | Eine Alchemie-Tätigkeit (Zubereitung) erstellt drei Einheiten (z.B. Tränke, Bomben oder Gifte) im relativen Zutatenverbrauch (x3). |
...
| **Bezeichnung** | **Effekt** | | **LV** |
| --- | --- | --- | --- |
| **Diebstahl (DB)** | **Fertigkeit: Die verrufene, verbotene Kunst des Stehlens, aus Taschen oder vor den Augen anderer.** Berechnung:(Geschicklichkeit + Charisma) / 2- Basis für Diebstahl jeder Art, ob nun aus Taschen, von Tresen oder unter Beobachtung anderer.- Basis für alle Schmuggelwürfe von Ausrüstung am eigenen Körper und dem Gepäck.HINWEIS: LV 1 muss durch einen Lehrmeister oder Lehrmaterial (wie ein Buch) angelernt werden. |
| **Schlossknacken (Befähigung)** | Ermöglicht es, Schlösser mit Dietrichen und anderen Hilfsmittel ohne den Schlüssel aufzuschließen.Kompetenz: Fingerfertigkeit (FF)HINWEIS: LV 1 muss durch einen Lehrmeister oder Lehrmaterial (wie ein Buch) angelernt werden. |
|  **Fingerfertigkeit LV 0**  | **Gewährt die Diebstahl (DB) und Schlossknacken (Befähigung)** | |  **0**  |
| „Diebesroutine&quot; (K!) | Nur Schurken: Der Schurke sucht nach Gelegenheit für harmlose Diebstähle. (Siehe Aktionen) |
|  **+ Fingerfertigkeit LV 1**  | **Gewährt +1 Diebstahl (DB)** | |**0**  |
| Dietrichmacher (Handwerk) | Ermöglicht es, aus Knochen einfache Dietriche herzustellen (max. 4 pro Abend). Erweitert zudem die Tätigkeit „Handwerk&quot; um Dietrichherstellung. |
| Fluchtreflex LV 1 (K!) | Nur Schurken: Routine eines Marktdiebes: Gewährt +1 auf alle Flucht- und Verfolgungswürfe. |
|  **+ Fingerfertigkeit LV 2**  | **Gewährt nochmalig +1 (insg. +2) Diebstahl (DB)** ||  **3**  |
| + Fluchtreflex LV 2 (K!) | Nur Schurken: Routine eines Marktdiebes: Gewährt nochmalig +1 (insg. +2) auf alle Flucht- und Verfolgungswürfe.
| „Befreien&quot; (E) | Sofortige Befreiung aus allen Fesseln und Verstrickungen. (Siehe Aktionen) |
|  **+ Fingerfertigkeit LV 3**  | **Gewährt nochmalig +1 (insg. +3) Diebstahl (DB)** | |  **6**  |
| + Fluchtreflex LV 3 (K!) | Nur Schurken: Routine eines Marktdiebes: Gewährt nochmalig +1 (insg. +3) auf alle Flucht- und Verfolgungswürfe. 
| „Aufbrechen&quot; (E) | Bricht Türen, Schlösser oder Mauern geschickt mit Gewalt auf. (Siehe Aktionen) |
| „Augenblick abwarten&quot; (E) | Erlaubt, einen Taschendiebstahl oder ein Schlösserknacken vor Zeugen durchzuführen. (Siehe Aktionen) |
|  **+ Fingerfertigkeit LV 4**  | **Gewährt nochmalig +1 (insg. +4) Diebstahl (DB)** | |  **9**  |
| „Gierblick&quot; | Der Charakter erkennt eventuelle Schatzverstecke. (Siehe Aktionen) |
|  **+ Fingerfertigkeit LV 5**  | **Gewährt nochmalig +1 (insg. +5) Diebstahl (DB)** | |  **12**  |
| „Leerstehlen&quot; | Gewährt für einen Taschendiebstahl +15 DB und raubt die Person bei Erfolg enorm aus. (Siehe Aktionen) |
|  **Erweiterung: Routine**  |  **Benötigt Fingerfertigkeit LV 2**  | |  **3**  |
| Ruhiges Händchen | Gewährt +1 AW / VW / BW / PJ, zudem +2 Fingerfertigkeit (FF). |
| Stehlian | Hat der Schurke genügend Zeit (etwa eine Minute), die er am Opfer steht, erhält er +5 auf Taschendiebstahl. |
...
| **Fähigkeit** | **EN** | **ZZ** | **Effekt** | **Bedingung(en)** |
| --- | --- | --- | --- | --- |
| Aufbrechen | 1 | 1 | Bricht eine Tür, ein Fenster, ein Schloss oder sogar eine dünne Wand mit routiniertem Geschick auf: Athletik (AT) gegen SG; mit einem Stemmeisen sogar AT +10 gegen SG. | Benötigt ein Werkzeug, notfalls eine Waffe. |
| Augenblick abwarten | 1 | - | Der Charakter beobachtet sein Umfeld und wartet den richtigen Augenblick ab, um zuzuschlagen. So kann er vor Zeugen einen Taschendiebstahl durchführen oder ein Schloss knacken. | - |
| Befreien | 1-3 | 1 | Der Charakter befreit sich sofort aus Verstrickungen: (FF gegen SG). Im Kampf: Befreit sich sofort aus einer Verstrickung, wie ein übergeworfenes Netz.Im Alltag: Befreit sich aus leichten Fesseln, Geiselsituationen, Ringkämpfen, Fallen, Feststeckungen und anderen, „fixierenden&quot; Situationen, nicht aber aus Storch-Schellen oder Handschellen. Kann unter Umständen bis zu 3 Stamina (EN) und / oder 10-30 TP kosten, falls Verrenkungen erforderlich sind. | Funktioniert nicht in jeder Situation. |
...
| Diebesroutine | 0 | - | Der Schurke durchsucht die Umgebung nach Gelegenheiten für harmlose, unauffällige Diebstähle – findet er welche, ergreift er sie automatisch. Berechnung: FF gegen SG. | Kann bis zu einer Stunde dauern. |
| Gierblick | 1 | - | Der Charakter überprüft instinktiv einen Ort oder Raum, wo es wertvolle Dinge zu holen gibt, versteckt oder Geheimtüren oder Fallen verborgen sein könnten. Berechnung: Bewusstsein (BW) oder Verständnis (VS) gegen SG. Gewährt zudem +10 auf einen Durchsuchungswurf. | - |
...
|  **Handwerk LV 0**  |  **Grundlegende Beherrschung: Negiert den Malus von -4 auf alle Handwerk-Würfe**  |
 |  **0**  |
| Materialkunde LV 1 | Grundwissen über Materialien sowie deren Beschaffenheit, Herstellungsverfahren, Qualitätsmerkmale u.v.m. Gewährt +1 bei der Identifikation und Überprüfung von Material und Gegenständen (ob bspw. auch die angepriesene Ware hält, was sie verspricht). |
| „Handwerk&quot; (T) | Tätigkeit: Der Charakter betätigt sich handwerklich. (Siehe Tätigkeiten) |
| „Reparieren&quot; (T) | Tätigkeit: Der Charakter repariert einen Gegenstand oder Mechanismus. (Siehe Tätigkeiten) |
|  **+ Handwerk LV 1**  | **Gewährt +1 Handwerk (HW)** |
 |  **0**  |
| + Materialkunde LV 2 | Erweitertes Grundwissen über Materialien und Herstellungsverfahren. Gewährt +1 (insg. +2) bei der Identifikation von Material und Gegenständen. |
| „Kesselflickerei&quot; (T) | Tätigkeit: Der Charakter führt für eine Gemeinschaft (auch gegen Geld) kleine Reparaturen durch. (Siehe Tätigkeiten) |
| + „Mineralogie&quot; (T) (Sammeln) | Benötigt und erweitert die Tätigkeit „Sammeln&quot; (Überleben) um die Suche nach Mineralien, Kristallen, Erzen oder anderen mineralischen Elementen. |
|  **+ Handwerk LV 2**  | **Gewährt +1 (insg. +2) Handwerk (HW)** |
 |  **3**  |
| + Materialkunde LV 3 | Erweitertes Wissen über Materialien und Herstellungsverfahren. Gewährt +1 (insg. +3) bei der Identifikation von Material und Gegenständen. |
| Rüstungsexpertise LV 1 | Der Charakter prüft und wartet seine Rüstung: Erhöht seinen Rüstungswert um 1. |
| „Notflickerei&quot; (E) | Repariert einen beschädigten Gegenstand (wie eine Rüstung oder Waffe) kurzzeitig, bis zur nächsten Rast. (Siehe Aktionen) |
| + „Reparieren&quot; LV 3 | „Reparieren&quot; wartet nun zwei Objekte oder gewährt zwei Versuche pro Tätigkeit. |
|  **+ Handwerk LV 3**  | **Gewährt +1 (insg. +3) Handwerk (HW)** |
 |  **6**  |
